		...
		?>
			<tr>
				...
				<td>
					...
					<a href="golongan-hapus.php?id=<?= $x->id ?>" class="btn btn-sm btn-danger">
						Hapus
					</a>
				</td>
			</tr>
...
<div class="modal fade" id="modalTambah">
	<div class="modal-dialog">
		<form class="modal-content" method="POST" action="golongan-tambah.php">
...
<div class="modal fade" id="modalUbah">
	<div class="modal-dialog">
		<form class="modal-content" method="POST" action="golongan-ubah.php">
			<div class="modal-header">
